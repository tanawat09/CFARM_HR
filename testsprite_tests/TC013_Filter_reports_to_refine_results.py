...
async def run_test():
    ...
    try:
        ...
        # -> Submit the login form by clicking the 'เข้าสู่ระบบ' button so the app navigates to the dashboard. Then wait for the UI to load the next page.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/div[3]/div[2]/form/div[2]/div[2]/button').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Open the Reports page by clicking the 'รายงาน' link in the sidebar.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/aside/div[2]/div[9]/a').nth(0)
        await asyncio.sleep(3); await elem.click()
