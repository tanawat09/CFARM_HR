...
async def run_test():
    ...
    try:
        ...
        # -> Try to load the app root (http://localhost:8000/) to trigger the SPA load, wait for the page to render, then re-check for login form fields (email, password, login button).
        await page.goto("http://localhost:8000/")
        
        # -> Enter the provided credentials into the email and password fields, then click the submit button to attempt login.
